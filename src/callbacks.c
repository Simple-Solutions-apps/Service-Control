...
{	
	...
	switch(sMsg)
	{
		...
		case WM_CREATE:
			...
			//cUniTitleAcc = malloc(23 * sizeof (LPCWSTR));
			//cUniTextAcc = malloc(60 * sizeof (LPCWSTR));
		...
		case WM_COMMAND:
			...
			{	
				...
				case IDC_BTN_TBCLEAR:
					...
					wcscpy_s((wchar_t *) cCommand, 10, TEXT(""));
						...
						case CBN_SELCHANGE:
							...
							switch(iComboIndex)
							{
								...
								case 1:
									...
									SendMessage(sHwndCtlCmbType, CB_ADDSTRING,0,(LPARAM) TEXT("adapt"));
									break;
